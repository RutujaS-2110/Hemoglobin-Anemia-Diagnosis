...
def home_page():
    ...
    try:
        img = Image.open("anemia.webp").resize((620, 400))
...
def diagnosis_page():
    with open("anemia_detector.pkl", "rb") as model_file:
